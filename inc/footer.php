            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link text-white-50" href="">Điều khoản và điều kiện</a>
                    </div>
                    <div class="col-lg-3 col-md-6">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>0886647098</p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>tung.nv182875@sis.hust.edu.vn</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="position-relative mx-auto" style="max-width: 400px;">
                            <input class="form-control bg-transparent w-100 py-3 ps-4 pe-5" type="text" placeholder="Email của ban">
