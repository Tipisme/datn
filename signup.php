            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">Sign up with <a href="index.php"
                        ...
                        <form method="POST" action="signup.php" class="register-form" id="register-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" placeholder="Your Name" value="<?php echo isset($form_data['name']) ? $form_data['name'] : ''; ?>" />
                            </div>
                            <div class="form-group">
                                <label for="email"><i class="zmdi zmdi-email"></i></label>
                                <input type="email" name="email" id="email" placeholder="Your Email" value="<?php echo isset($form_data['email']) ? $form_data['email'] : ''; ?>" />
                            </div>
                            <div class="form-group">
